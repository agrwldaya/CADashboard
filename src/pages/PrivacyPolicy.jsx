    ...
    <div className={darkMode ? "bg-gray-900 text-white" : "bg-white text-black"}>
      ...
      >
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="text-lg mt-2 sm:text-xl md:text-2xl">We prioritize your data privacy, ensuring all personal information is securely collected, stored, and used in compliance with industry standards.</p>
        </div>
      </div>
      ...
      >
        <p className="text-lg sm:text-xl md:text-2xl">© 2025 Cloudatahub. All rights reserved.</p>
      </footer> */}
    </div>
  );
};
