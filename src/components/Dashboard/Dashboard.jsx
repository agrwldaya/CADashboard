...
const Dashboard = () => {
  ...
  const MobileHeader = () => (
    <div className="md:hidden fixed top-0 left-0 right-0 bg-gray-900 shadow-md z-20 p-4">
      <div className="flex justify-between items-center">
        <Link to="/">
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-gray-100 font-sans">
      ...
      {/* Main Content */}
      <div 
        className="flex-1 flex flex-col w-full md:w-auto overflow-hidden mt-20 md:mt-0"
        onClick={() => {
